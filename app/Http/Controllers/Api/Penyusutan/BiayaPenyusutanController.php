...
namespace App\Http\Controllers\Api\Penyusutan;
...
class BiayaPenyusutanController extends Controller
{
    ...
    {
        try {
            $data = BiayaPenyusutan::with(['allocation'])->get();
    ...
    {
        try {
            $data = BiayaPenyusutan::with(['allocation'])->findOrFail($id);
    ...
    public function indexLatest()
    {
        try {
            ...
            $data = BiayaPenyusutan::with('allocation')
    ...
    public function store(Request $request)
    {
        ...
        try {
            $rules = [
                'alokasi_id' => 'required|exists:' . Allocation::class . ',id',
            ...
            $existingEntry = BiayaPenyusutan::where('alokasi_id', $request->alokasi_id)
            ...
            $data = BiayaPenyusutan::create($request->all());
