...
class MasterTipeRekeningController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        try {
            $validator = Validator::make($request->all(), [
                'nama' => 'required|string|unique:master_tipe_cash_on_hand,nama',
            ]);
            ...
            $data = MasterTipeRekening::create($request->all());
    ...
    public function update(Request $request, $id)
    {
        ...
        try {
            ...
            $rules = [
                'nama' => 'required|unique:master_tipe_cash_on_hand,nama,' . $id,
            ];
