...
class MasterBulkProduksiController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        try {
            ...
            $data = MasterBulkProduksi::create($request->all());
    ...
    public function update(Request $request, $id)
    {
        ...
        try {
            ...
            $mBulky = MasterBulkProduksi::find($id);
