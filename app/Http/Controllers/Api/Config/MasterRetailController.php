...
class MasterRetailController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        try {
            $validator = Validator::make($request->all(), [
                'name' => 'required|unique:master_retail,name',
            ]);
            ...
            $data = MasterRetail::create($request->all());
    ...
    public function update(Request $request, $id)
    {
        ...
        try {
            ...
            $validator = Validator::make($request->all(), [
                'name' => 'required|unique:master_retail,name,' . $id,
            ]);
