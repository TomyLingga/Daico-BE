...
class MasterJenisRekeningController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        try {
            $validator = Validator::make($request->all(), [
                'nama' => 'required|string|unique:master_jenis_rekening,nama',
            ]);
            ...
            $data = MasterJenisRekening::create($request->all());
